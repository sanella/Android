            ...
            public void onResponse(Response response) throws IOException {
                try {
                    ...
                    for(int i = 0; i < array.length(); i++){
                        ...
                        mFeed.add(new Coupon(name, price, dateCreated, dateExpire, picture, category, description, remark, minOrder, maxOrder, usage, seller ));
